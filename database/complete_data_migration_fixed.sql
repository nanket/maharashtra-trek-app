-- Complete Data Migration for Maharashtra Trek App (FIXED for current schema)
-- This version uses individual safety columns instead of single safety JSONB column
...
-- Verification
SELECT COUNT(*) as total_inserted FROM treks;
SELECT 'Migration completed successfully with individual safety columns!' as status;